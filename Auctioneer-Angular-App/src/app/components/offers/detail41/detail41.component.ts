...
@Component({
  ...
  styleUrls: ['./detail41.component.css']
})

export class Detail41Component implements OnInit, OnDestroy {
  ...
  // canDeactivate() {
  //   console.log('CANDEACTIVATE IN CHILDDSDFASDF' + this.stateNoDelta);
  //
